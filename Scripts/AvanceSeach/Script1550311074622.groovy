...
WebUI.scrollToElement(findTestObject('AdvanceSearch_Page/option_Plans'), 4)

WebUI.waitForElementClickable(findTestObject('AdvanceSearch_Page/option_Plans'), 2)

WebUI.click(findTestObject('AdvanceSearch_Page/option_Plans'))
