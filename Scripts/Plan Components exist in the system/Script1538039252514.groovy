...
WebUI.click(findTestObject('Page_Callidus Cloud Commissions Man/a_Plan Components'))

println('User Naviagted to Plan Components screen')
...
WebUI.setText(findTestObject('Page_Callidus Cloud Commissions Man/td_Value'), PlanComponentName)
