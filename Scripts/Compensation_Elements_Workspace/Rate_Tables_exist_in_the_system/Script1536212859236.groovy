...
WebUI.waitForElementVisible(findTestObject('HomePage_Commission/Commission_CompensationElements/Link_Rate Tables'), 5)

WebUI.mouseOver(findTestObject('HomePage_Commission/Commission_CompensationElements/Link_Rate Tables'), FailureHandling.STOP_ON_FAILURE)

'Clicking on Rate tables link '
WebUI.click(findTestObject('HomePage_Commission/Commission_CompensationElements/Link_Rate Tables'))

'Verifying the linktext of rate tables'
Assert.assertEquals(WebUI.getText(findTestObject('Assertion_objects/Rate Tables')), Ratetabletxt)

println('User Navigated to Rate Tables screen')
...
WebUI.setText(findTestObject('AdvanceSearch_Page/td_Value'), Rate_table)
