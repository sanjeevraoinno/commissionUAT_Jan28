...
Assert.assertEquals(WebUI.getText(findTestObject('Assertion_objects/Variable')), Varaiabletxt)
...
WebUI.setText(findTestObject('AdvanceSearch_Page/td_Value'), R_T_Var)
