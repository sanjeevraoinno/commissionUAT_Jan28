...
'Clicking on Territory link'
WebUI.click(findTestObject('HomePage_Commission/Commission_CompensationElements/Link_Territory'))

'Verifying the linktext of territory '
Assert.assertEquals(WebUI.getText(findTestObject('Assertion_objects/Territory')), Territorytxt)

println('User Navigated to Territory screen')
