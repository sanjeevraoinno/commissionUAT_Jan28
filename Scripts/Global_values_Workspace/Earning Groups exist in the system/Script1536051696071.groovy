...
'Clicking on Earning groups link'
WebUI.click(findTestObject('HomePage_Commission/Commission_Globalvalues/Link_Earning Groups'))

'Verifying the linktext of Earning groups'
Assert.assertEquals(WebUI.getText(findTestObject('Assertion_objects/Earning groups')), EG_txt)

println('User Navigated to Earning Groups screen')
